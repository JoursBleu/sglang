...
The arithmetic mirrors EngramHasher's torch path (sglang.srt.layers.engram) and the
pure-torch oracle in test/manual/deepseek_v41; all three must stay bit-identical.
"""
